from src.editorial_calendar import DayProfile, get_profile
...
LUCIDEZ_REVISADA_PROFILE = get_profile("terca")


def revised_lucidity_quotes() -> list[VerifiedQuote]:
    """Seleção excepcional para substituir uma pauta que não atingiu o padrão editorial."""

    return [
        VerifiedQuote(
            quote_pt="Se podes olhar, vê. Se podes ver, repara.",
            author="",
            source_title="Livro dos Conselhos, de D. Duarte — epígrafe de Ensaio sobre a Cegueira",
            source_url="https://jornal.usp.br/artigos/se-podes-olhar-ve-se-podes-ver-repara/",
            source_type="obra histórica e referência acadêmica",
            source_excerpt="A frase é identificada como epígrafe de Ensaio sobre a Cegueira.",
            original_language="português",
            translated=False,
            theme="lucidez e atenção",
            verification_note="A autoria foi omitida na arte para evitar atribuição imprecisa; a fonte confirma seu uso como epígrafe no romance.",
        ),
        VerifiedQuote(
            quote_pt="Não me pergunte quem sou e não me diga para permanecer o mesmo.",
            author="Michel Foucault",
            source_title="A Arqueologia do Saber",
            source_url="https://pt.wikiquote.org/wiki/Michel_Foucault",
            source_type="obra filosófica",
            source_excerpt="Não me pergunte quem sou e não me diga para permanecer o mesmo.",
            original_language="francês",
            translated=True,
            theme="identidade e transformação",
            verification_note="Formulação curta atribuída à introdução de A Arqueologia do Saber; selecionada por clareza e força editorial.",
        ),
        VerifiedQuote(
            quote_pt="A estupidez insiste sempre.",
            author="Albert Camus",
            source_title="A Peste",
            source_url="https://pt.wikiquote.org/wiki/Albert_Camus",
            source_type="obra literária",
            source_excerpt="La bêtise insiste toujours.",
            original_quote="La bêtise insiste toujours.",
            original_language="francês",
            translated=True,
            theme="lucidez e discernimento",
            verification_note="Tradução direta de formulação atribuída a A Peste; selecionada por concisão e tensão.",
        ),
    ]
